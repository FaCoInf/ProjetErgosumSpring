...
//
//	/**
//	 * Sï¿½lection d'une annï¿½e par catï¿½gorie
//	 */
...
//
//	/**
//	 * Sï¿½lection d'une annï¿½e Ctagoriet
//	 */
...
//			if (unService != null) {
//
//				// fabrication du jouet ï¿½ partir des paramï¿½tres de la requï¿½te
//				// Si le jouet n'est pas ï¿½ crï¿½er, il faut le rï¿½cupï¿½rer de la
//				// session
//				// courante
...
//					unJouet = new Jouet();
//				else { // on rï¿½cupï¿½re le jouet courant
//
...
//					System.out.println("Je suis ï¿½ la quantitï¿½ ");
//					;
